...
acc_btc_gru=c(metriks(train_btc,GRU_fit_btc),metriks(test_btc,LSTM_pred_btc))
...
acc_eth_gru=c(metriks(train_eth,GRU_fit_eth),metriks(test_eth,LSTM_pred_eth))
...
acc_ltc_gru=c(metriks(train_ltc,GRU_fit_ltc),metriks(test_ltc,LSTM_pred_ltc))
